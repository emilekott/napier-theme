    ...
    <div class="grid_4 alpha">
        <div class="box">
            <div class="box-inner">
                ...
                <table class="contact">
                    <tr><td><img src="<?php bloginfo('stylesheet_directory'); ?>/images/tel.png" alt="Tel:" /><td class="contact-details">0207 078 0849</td><td><a href="http://www.youtube.com/NapierPR"><img class="social-button" src="<?php bloginfo('stylesheet_directory'); ?>/images/youtube.png" /></a><a href="https://twitter.com/NapierPR"><img class="social-button middle" src="<?php bloginfo('stylesheet_directory'); ?>/images/twitter.png" /></a><a href="http://www.slideshare.net/NapierPR"><img class="social-button" src="<?php bloginfo('stylesheet_directory'); ?>/images/other.png" /></a></td></tr>
                    <tr><td><img src="<?php bloginfo('stylesheet_directory'); ?>/images/mail.png" alt="Tel:" /><td class="contact-details"><a href="mailto:mike@napier.co.uk">mike@napier.co.uk</a></td><td><a href="http://www.linkedin.com/company/215406"><img class="social-button" src="<?php bloginfo('stylesheet_directory'); ?>/images/linked-in.png" /></a><a href="<?php bloginfo('rss2_url'); ?>"><img class="social-button middle" src="<?php bloginfo('stylesheet_directory'); ?>/images/rss.png" /></a><a href="http://www.facebook.com/NapierPR"><img class="social-button" src="<?php bloginfo('stylesheet_directory'); ?>/images/facebook.png" /></a></td></tr>
                </table>
            </div>
        </div>
    </div>
